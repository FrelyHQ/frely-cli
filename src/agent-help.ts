...
export const COMMANDS = [
  ...
  { id: "status", usage: "frely status [--json]", auth: "none", effect: "read", purpose: "Inspect CLI and authentication status." },
  { id: "doctor", usage: "frely doctor [--mcp] [--json]", auth: "optional-account", effect: "diagnostic", purpose: "Check runtime and credential-store availability." },
  ...
  { id: "mcp.status", usage: "frely mcp status [--json]", auth: "none", effect: "read", purpose: "Inspect local MCP authorization metadata." },
  ...
  { id: "mcp.service", usage: "frely mcp service status|start|stop|uninstall [--json]", auth: "none", effect: "local-service", purpose: "Manage the local MCP background service." },
